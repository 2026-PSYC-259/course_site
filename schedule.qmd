...
##  `r advdate(wed, 6)`: [Workflow Critique Presentations](assignments/WorkflowCritique.qmd)
...
- First set of [Final Project Presentations](assignments/FinalProject.qmd)

##  `r advdate(wed, 10)`: [Visualization and Final Project Presentations (Part 2)](lectures/8Visualization.qmd)

- Second set of [Final Project Presentations](assignments/FinalProject.qmd)