...
**Due Date**. You should make your Github repository public and submit the repository link on Canvas. If you prefer to make it private (such is if you have data that should not be shared publicly), you can make a private Github repository and add the instructors as users. 
